...
class Note:    
    ...
    def type_self(self):
        print('\nType self:')
        print(type(self))
        print('The contents of self: \n', dir(self))

    def match(self, filter):        
        '''Determine if this note matches the filter text. Return True if it matches, 
        False otherwise. Search is case sensitive and matches both text and tags.'''        
        return filter in self.memo or filter in self.tags
    
    def __str__(self):
        return 'Just a humble string. I can do this: {}.'.format(self.memo)
...
class Menu:    
    ...
    def display_menu(self):        
        print(""" Notebook Menu 1. Show all Notes 2. Search Notes 
        3. Add Note 4. Modify Note 5. Quit """)
